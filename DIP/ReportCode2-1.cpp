...
*	작성자 : 박도령
*	학번	  : 2010112406
*	설명	  : 두 이미지를 로드하여 합한 결과 이미지를 윈도우창 형태로 출력한다.
*/
...
int main(int argc, char* argv[])
{
	...
	char *winForBlended = "Blended Image";//이미지1과 이미지2를 합한 결과의 윈도우 이름
	...
	else//성공적으로 로드 되었을 경우
	{
		...
		//두 이미지를 더해서 결과 이미지에 넣는다.
		cvAdd(pImgIpl1, pImgIpl2, pImgBlended, NULL);
